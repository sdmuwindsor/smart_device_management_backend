...
class AnomalyDetection:
     ...
     def plot_graph(self,html_file_path):
        ...
        with open(html_file_path, 'a') as report:
            ...
            #pdfkit.from_file(html_file_path, html_file_path.split(".")[0]+".pdf",configuration=config)
            #pdfkit.from_file(r"C:\Users\gupta\OneDrive\Desktop\Smart_Device_Management\\"+html_file_path, r"C:\Users\gupta\OneDrive\Desktop\Smart_Device_Management\out2.pdf",configuration=config,verbose=True, options={"enable-local-file-access": True})
